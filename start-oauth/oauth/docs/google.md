...
![image](./images/google01.png)

## 3. Google 인증 플랫폼 프로젝트 구성

![image](./images/google02.png)

## 4. OAuth클라이언트 만들기

![image](./images/google03.png)
![image](./images/google04.png)

## 5. 동의 항목 설정

### 제공할 데이터 선택

![image](./images/google06.png)

## 6. 클라이언트 ID와 클라이언트 보안 비밀번호를 이용하여 개발 시작

![image](./images/google05.png)